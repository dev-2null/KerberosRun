...
namespace KerberosRun
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            }).ParseArguments<AskTGTOptions, AskTGSOptions, KerberoastOptions, AsreproastOptions, S4UOptions, S4U2SelfOptions, GoldentOptions, SilverOptions, PTTOptions>(args);
